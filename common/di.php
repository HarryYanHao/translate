...
class Di implements \ArrayAccess{  
  ...
  protected static $_instances = array();//已经实例化的服务
  ...
  public function has($name){  
      return isset($this->_bindings[$name]) or isset(static::$_instances[$name]);
  }  
    
  //卸载服务  
  public function remove($name){  
      unset($this->_bindings[$name],static::$_instances[$name]);
  }  
